		...
		<div class="card mb-4">
			...
			<div class="card-body">
				<div class="table-responsive">
					<form role="form" action="/ht/modify" method="post">
	...
	<script type="text/javascript">
		$(document).ready(function(){
				...
				$("button").on("click", function(e){
						...
						if(operation == 'remove'){
								formObj.attr("action", "/ht/remove");
						}else if(operation == 'list'){
								
								formObj.attr("action", "/ht/postlist").attr("method", "get");
...
$(document).ready(function() {
  (function(){
    ...
    $.getJSON("/ht/getImgList", {postNum: postNum}, function(arr){
