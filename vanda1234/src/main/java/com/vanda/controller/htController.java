...
public class htController {
	...
	Logger log = LoggerFactory.getLogger(htController.class);
	...
	public void list(Criteria crt, Model model) {
		...
		int total = service.htgetTotal(crt);
		log.info("total:" + total);
		model.addAttribute("list", service.htgetList(crt));
...
//		return "redirect:/post/postlist";
		...
		return "redirect:/ht/postlist" + crt.getListLink();
	}
