				...
				<div class="table-responsive">
					<form role="form" action="/ht/register" method="post">
						<div class="form-group">					
							<input type="hidden" class="form-control" name="classNum" value="3" readonly="readonly">
						</div>
						<div class="form-group">
							<label>아이디</label> 
							<input class="form-control" name="userId" value="${check.user_id}" readonly="readonly" >
						</div>
						<div class="form-group">
							<label>제목</label> 
