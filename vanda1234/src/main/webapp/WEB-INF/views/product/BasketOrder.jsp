...
<body>
	<h2>수령인 상세정보 입력창</h2>
	<div class="orderInfo">
		<form id="orderForm" name="orderForm" role="form" action="/product/basketOrder" method="post" autocomplete="off">
			...
			총가격 : <input type="text" id="pay_price" name="pay_price" value="${total}" readonly ="readonly">원
	...
	<script>
		...
		$('#buy_btn').click(function() {
			...
			IMP.request_pay({
				...
				if (rsp.success) {
					$.ajax({
						url : "http://localhost:8080/product/basketOrder",
						type : "POST",
						data : data,
