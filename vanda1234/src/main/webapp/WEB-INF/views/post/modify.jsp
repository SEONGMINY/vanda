			...
			<div class="card-body">
				<div class="table-responsive">
					<form role="form" action="/post/modify" method="post">
						...
						<div class="form-group">
							<label>내용</label>
							<textarea class="form-control" rows="3" name="postContent"><c:out
									value="${post.postContent}" /></textarea>
						</div>
						<div class="form-group">
						...
						if(operation == 'remove'){
							...
							var str = "";
								 ...
								 $(".uploadResult1 ul li").each(function(i, obj){
							            ...
							            str += "<input type='hidden' name='imgList1["+i+"].fileName' value='"+jobj.data("filename")+"'>";
							            str += "<input type='hidden' name='imgList1["+i+"].uuid' value='"+jobj.data("uuid")+"'>";
							            str += "<input type='hidden' name='imgList1["+i+"].uploadPath' value='"+jobj.data("path")+"'>";
							            str += "<input type='hidden' name='imgList1["+i+"].fileType' value='"+ jobj.data("type")+"'>";
...
$(document).ready(function() {
  ...
  function showUploadResult1(uploadResultArr1) {

	  	alert(uploadResultArr1);

		if (!uploadResultArr1 || uploadResultArr1.length == 0) {
			return;
		}
